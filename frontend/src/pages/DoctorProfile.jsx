...
const DoctorProfile = () => {
  ...
  return (
    <div className="max-w-[1400px] mx-auto pt-6 pb-16 animate-fade-in px-4 sm:px-0">
            ...
            <div className="flex-1 w-full pt-2 md:pt-4 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              ...
              <div className="flex gap-3 w-full md:w-auto">
                <Button variant="outline" className="flex-1 md:flex-none">
                  <svg className="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                  Save
                </Button>
                {/* Scroll to book logic could go here, but Calendar is fixed on right */}
              </div>
            </div>
